...
export default function ContactPage() {
  ...
  const heroSymbols = [
    ...
    { s: '∞', sz: '3.5rem', t: '55%', l: '8%', d: 2.2, dur: 10, r: -15 },
    { s: 'θ', sz: '2.8rem', t: '15%', l: '35%', d: 2.8, dur: 9, r: 10 },
    { s: '≈', sz: '3rem', t: '90%', l: '25%', d: 1.5, dur: 8, r: 18 },
    { s: '∫', sz: '4rem', t: '35%', l: '20%', d: 0.8, dur: 12, r: -12 },
  ];
